...
const dates = [
  ...
  {
    icon: "📅",
    name: "Jai Gurubande Ashram, Nagwa District-Nagawa Ashram (Ghazipur)",
    schedule: "Every month on dates 4 and 19",
    contact: "📞 7080224203, 9839088123",
  },
  {
    icon: "📅",
    name: "Jai Gurubande Ashram, Ahiraura-Mirzapur Ashram",
    schedule: "Every month on date 3",
    contact: "📞 7651881816",
  },
  {
    icon: "📅",
    name: "Jai Gurubande Satsang Program-Shivramapur, District Varanasi, Uttar Pradesh (At the residence of Shri Girja Prasad Yadav Ji)",
    schedule: "Every month on date 27",
    contact: "📞 8738868292",
  },
  {
    icon: "📅",
    name: "Jai Gurubande Ashram, Sidhagar Ghat Ashram (Ghazipur), Uttar Pradesh",
    schedule: "Every month on date 23",
    contact: "📞 8808305735, 9793900455",
  },
  {
    icon: "📅",
    name: "Jai Gurubande Ashram, District Gorakhpur, Uttar Pradesh",
  ...
  },
  {
    ...
    schedule: "Every month from dates 6 to 11",
    contact: "📞 9819560938",
  },
  {
    icon: "📅",
    name: "Jai Gurudev Ashram, Parsouli (Near Tarwa, Azamgarh, Uttar Pradesh)",
    schedule: "Schedule not specified",
    contact: "📞 Not available",
  },
  {
    icon: "📅",
    name: "Jai Gurudev Ashram, Sachin (Surat, Gujarat)",
    schedule: "Schedule not specified",
    contact: "📞 Not available",
  },
  {
    icon: "📅",
    name: "Jai Gurudev Satsang Program, Vasco da Gama (Goa)",
    schedule: "Schedule not specified",
    contact: "📞 Not available",
  },
];
